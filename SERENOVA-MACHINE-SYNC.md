...
> Last Updated: 2026-06-23T00:30 EDT
...
| What | Value |
|---|---|
| Code repo `main` HEAD | `d91a3af` — "MobileHub itinerary: merge Travel card, time-first rows, Day Schedule cleanup" |
| Serenova version | **0.6.0581** |
