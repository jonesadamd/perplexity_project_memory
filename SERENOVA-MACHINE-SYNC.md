...
| **desktop** | EventDetails **#7c** — all-hotels-on-map / >1-hotel driving-only + hotel→airport leg | 🔨 **in progress (desktop) 2026-06-22** | claimed from `0.6.0571`; from the #7 working-doc "multiple hotels" note |
