...
| _(unclaimed)_ | EventDetails **#10** — Set List as a popup button (small; mirror the guest popup pattern) + tidy: remove unused `getStatusBadge`/`getContractBadge` from `EventDetails.jsx` | next | — |
