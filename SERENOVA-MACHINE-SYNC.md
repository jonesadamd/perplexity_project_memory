...
| What | Value |
|---|---|
| Code repo `main` HEAD | `aa22b4e` — "MobileHub: venue route + drive/airport times on event detail" |
| Serenova version | **0.6.0574** |
