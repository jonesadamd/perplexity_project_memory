...
| **desktop** | B4.2 — Verify-gated phone/email change | 🔨 **in progress (desktop) 2026-06-22** | claimed from `0.6.0573`; re-key Memberships on email change; Verify code on phone change |
